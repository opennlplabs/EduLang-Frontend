...
export function getUserInfoFirebase() {
  ...
  //           var translatedLanguageConfig =
  //             snapshot.data()?.translatedLanguageConfig;
...
export function setUserInfo(
  ...
  return null;
  //   const info = {};
  //   if (nativelanguage != undefined && nativelanguage != null) {
  //     info.nativeLanguage = nativelanguage;
  //   }
  //   if (translatedlanguage != undefined && translatedlanguage != null) {
  //     info.translatedLanguageConfig = translatedlanguage;
  //   }
