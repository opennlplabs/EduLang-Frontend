...
const LiveTranslation = ({ navigation, route }) => {
  ...
  return (
    <View>
      {/* Intro Text */}
      <Text style={styles.IntroText}>Take pictures of the book that you want to translate using the "Add Page" button. {"\n"}{"\n"}When you are done, click "Translate" button!</Text>
